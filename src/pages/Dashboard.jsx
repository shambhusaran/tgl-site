...
const Dashboard = () => {
    return (
        ...
        <div className="flex flex-col w-full h-full  justify-center  ">
                <div className="text-5xl md:text-7xl  font-montserrat font-bold text-white text-center tracking-normal leading-12"> Impacting Livess Through Technology and Innovation</div>
