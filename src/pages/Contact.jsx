...
const Contact = () => {
  return (
    <div id="contact-us" className="relative bg-cover  mt-40 mb-40 ">
      ...
      <div className=" relative z-100 w-[calc(90%)] sm:w-[calc(70%)] mx-auto ">
        <div className="  w-6/7 flex flex-col  mx-auto  items-center pt-36">
          <h1 className="  text-6xl sm:text-7xl font-montserrat text-primary font-bold mb-12 ">
            Contact
          </h1>
          <div>
          ...
          <div className="grid md:grid-cols-2 w-full mt-20 sm:mt-36 gap-16">
            <div className=" px-10 sm:px-20 bg-gray-50 rounded-3xl py-4 sm:py-12">
              <h1 className="font-montserrat text-4xl sm:text-5xl font-semibold text-primary py-8 sm:py-12 ">
                Send us a Message
              </h1>
              <p className="font-montserrat text-xl sm:text-2xl mb-4 text-red-700">
                Fields marked with * is mandatory
              </p>
              <form className="flex flex-col items-center w-full mx-auto">
                <label
                  htmlFor="name"
                  className="self-start font-montserrat text-2xl sm:text-3xl font-semibold flex"
                >
                  Full Name
                ...
                <label
                  htmlFor="phone"
                  className="self-start font-montserrat text-2xl sm:text-3xl mt-8 font-semibold"
                >
                  Phone Number
                </label>
                <input
                ...
                <label
                  htmlFor="phone"
                  className="self-start font-montserrat text-2xl sm:text-3xl mt-8 font-semibold flex"
                >
                ...
                />
                <button className="px-10 py-6 mt-12 mb-8 sm:mb-0 justify-self-center shadow-2xl cursor-pointer bg-primary font-semibold  text-2xl text-white rounded-xl ">
                  Send Message
                </button>
              </form>
            </div>
            <div className="flex flex-col" >
              <div className="md:mt-80 px-8 py-6 flex items-baseline justify-between"> <p className="font-montserrat text-3xl font-semibold">Our Location</p> <a className="flex items-center font-montserrat text-2xl"> GET DIRECTION <FaArrowRight className="ml-2"/></a></div>
              ...
              <iframe
                ...
                // width="600"
                // height="450"
           className=" px-8 h-96 sm:h-3/6  w-full "
                allowFullScreen=""
                loading="lazy"
